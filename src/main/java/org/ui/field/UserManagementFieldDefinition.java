...
/**
 * A definition for the User Management field.
 */
public class UserManagementFieldDefinition extends TwinColSelectFieldDefinition {
    @SuppressWarnings("unchecked")
    public UserManagementFieldDefinition() {
