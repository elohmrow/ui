...
/**
 * A definition for the Tag Management field.
 */
public class TagManagementFieldDefinition extends TwinColSelectFieldDefinition {
    @SuppressWarnings("unchecked")
    public TagManagementFieldDefinition() {
